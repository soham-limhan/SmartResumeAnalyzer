...
import { Trash2, ExternalLink, FileText, Calendar, Search } from 'lucide-react';
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className={`px-3 py-1.5 rounded-lg text-sm font-bold ${getScoreColor(item.analysis?.ats_score || 0)}`}>
