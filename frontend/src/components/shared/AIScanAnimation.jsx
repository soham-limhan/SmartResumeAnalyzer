  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-8">
      ...
      <div className="relative w-24 h-24 flex items-center justify-center">
        ...
        {/* Core icon */}
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-violet-500/20 border border-indigo-500/30 flex items-center justify-center relative overflow-hidden">
          {/* Scan line */}
          <motion.div
            className="absolute left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-cyan-400/80 to-transparent"
            animate={{ top: ['0%', '100%', '0%'] }}
